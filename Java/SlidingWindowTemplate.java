...
public class SlidingWindowTemplate {
	/*
	 In any sliding window based problem we have two pointers. One end pointer whose job is to expand the current window and then we have the begin pointer whose job is to contract a given window. 
